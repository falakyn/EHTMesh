...
Прошивка в репозитории обновлятся не будет так что если хотите свежие версии прошивки нужно компилировать её по гайду ниже.
...
| `#define ADC_MULTIPLIER 3.16`            | Коэффициент значения с АЦП. Если показывает заряд\напряжение не правильно можно чуть поменять.    |
